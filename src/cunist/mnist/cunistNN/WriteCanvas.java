...
public class WriteCanvas extends Canvas{
    private static int widthAndHeight = cunist.mnist.cunistNN.Const.widthAndHeight;
    ...
    public WriteCanvas(cunist.mnist.cunistNN.DotMatrixCanvas dotMatrixCanvas, MainGraphic mainGra){
        super();
        try {
